...
const VideoModal = (props: any) => {
  ...
  const onFullScreen = (obj: { seekTime: number; buffer: number; paused: any; isFull: boolean | ((prevState: boolean) => boolean) }) => {
  ...
  const onModalFullScreen = (obj: { seekTime: number; buffer: number; paused: any; isFull: boolean | ((prevState: boolean) => boolean) }) => {
